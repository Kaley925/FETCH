...
const Cats = () => {
    ...
    return(
        ...
        <h4 className='top-paragraph'>we have many cats to choose from, all in desperate need of a home.  Adopt a cat today to not only save a life, but to also gain a best friend in the process!</h4>
        <button className="mt-4 cat-top-button btn">See Our Cats Below <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
</svg></button>
              </div>
              <div className="cat-img">

        <img className="cat-img " src="https://i.imgur.com/EvsdNGR.png" alt="cat"/>
              </div>
            </div>
          </header>
        ...
        <img className="house-img  " src="https://i.imgur.com/bvP9NJ0.png" alt="house"/>
        <h3 className="cat-lower-one text-center">Cats are playful</h3>
             </div>
        </div>
        <div className="col">
        <div className="d-flex flex-column align-items-center justify-content-center">

        <img className="badge-img " src="https://i.imgur.com/VBBfDxR.png" alt="badge"/>
        <h3 className="cat-lower-two text-center">Cats are loyal</h3>
</div>
        ...
        <img className="girl-img" src="https://i.imgur.com/LmBzKq3.png" alt="girl"/>
        <h3 className="cat-lower-three text-center">Cats are affectionate</h3>
</div>
        </div>
          </div>
        </div>
              ...
              {/* <img src={cats.photos} className="card-img-top"/> */}
               ...
               {cats.age == "adult" ? (
                ...
                <h5 className="card-text">I'm {dis()} miles away from you</h5>
                 <button type="button" className="btn btn-dark cat-favorite-btn">Favorite Me</button>
                 <br/>
                 <a href={cats.url} className="btn-view-cat">View Cat </a> 
